import type { MealTypeFilter } from '../types'

/** 餐次筛选 chips 的 props */
interface MealTypeChipsProps {
  active: MealTypeFilter
  onChange: (mealType: MealTypeFilter) => void
}

// 餐次筛选选项：全部 + 三餐
const MEAL_TYPE_CHIPS: Array<{ key: MealTypeFilter; label: string }> = [
  { key: 'all', label: '全部' },
 ...
 */
export default function MealTypeChips({ active, onChange }: MealTypeChipsProps) {
  return (
